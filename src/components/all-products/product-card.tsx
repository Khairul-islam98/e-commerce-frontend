  ...
  return (
    ...
    <div className="group relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow hover:shadow-lg transition-shadow">
      ...
      <div className="p-4 space-y-3">
        ...
        <Badge
          variant="outline"
          className="text-xs bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded px-2 py-1"
        >
        ...
        <Link
          ...
          className="block text-base font-semibold text-gray-800 dark:text-gray-200 hover:text-main transition"
        >
          {name}
        </Link>
